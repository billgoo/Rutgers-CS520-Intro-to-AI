...
def probablisticSearch(map, targetx, targety, policy):
    ...
    while True:
        ...
        print("Current cell is [%s,%s], %s" % (current_i,current_j,beliefmap[current_i][current_j]))
        ...
        if count == 1 or (current_i==query_i and current_j==query_j):
            ...
            if policy == 1:
                ...
                p = 0
                if map[current_i][current_j] == flat:
                    p = 0.9
                elif map[current_i][current_j] == hilly:
                    p = 0.7
                elif map[current_i][current_j] == forested:
                    p = 0.3
                else:
                    p = 0.1
        ...
        if if_search == 1:
            ...
            if query_result == 1:
                print("Target found at [%s,%s], %s." % (current_i, current_j,map[current_i][current_j]))
...
if __name__ == '__main__':
    ...
    #
    # average2 = searchstep2 /10
    # average4 = movestep2 / 10
