...
class MDP:
    ...
    def __init__(self, beta, buy_cost):
        # def __init__(self, init, actlist, terminals, beta=.9):
        '''
        update(self, init=init, actlist=actlist, terminals=terminals,
               beta=beta, states=set(), reward={})
               '''
        self.t_used, self.t_replace, self.reward_used, self.reward_replace = [], [], [100], [0]
        self.beta = beta
        self.build_model(buy_cost)

    def build_model(self, buy_cost):
        ...
        for i in range(1, 10):
            ...
            self.t_replace.append([(0.5, 1), (0.5, 2)])
        ...
        for i in range(1, 10):
            self.reward_replace.append(buy_cost)
